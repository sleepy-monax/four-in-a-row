...
public class SelectTheme extends View {
    ...
    public SelectTheme(List<String> lTheme, int nbTheme) {
        ...
        Pane theme2Button = Widgets.makeBigButton(Icon.STAR, "Thème 2" /* lTheme.get(1).toString() */);
        ...
        Pane theme3Button = Widgets.makeBigButton(Icon.STAR, "Thème 3" /* lTheme.get(2).toString() */);
